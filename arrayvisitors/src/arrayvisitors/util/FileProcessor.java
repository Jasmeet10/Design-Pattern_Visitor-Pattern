...
public final class FileProcessor {
	...
	public FileProcessor(String inputFilePath)
		...
		Driver.logger.logMessage("In the FileProcessor constructor");
	...
	public String poll() throws IOException {
		Driver.logger.logMessage("In the FileProcessor class using poll method");
	...
	public void close() throws IOException {
		Driver.logger.logMessage("In the FileProcessor class using close method");
		reader.close();
	}
}
